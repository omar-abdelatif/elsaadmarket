                                ...
                                <div className="sidemenu-body">
                                    <ul className='navbar-nav user-list'>
                                        <li className='nav-item'>
                                            <Link to={'/elsaadmarket/dashboard'} className='nav-link active dash'>
                            ...
                            <div className="dashboard-container">
                                <div className="row justify-content-center">
                                    {Data.BoxData.map(box => (
                                        <div className="col-lg-3 col-md-6" key={box.id}>
                                            <div className="box" >
                                                <div className="box-header">
                                                    <h4>{box.title}</h4>
                                                    <p>{box.count} {box.unit}</p>
                                                </div>
                                                <div className={box.iconBgColor}>
                                                            ...
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-footer">
                                                                    <div className="footer-btns">
                                                                        ...
                                                                        <button type="button" onClick={this.handleClick} class="btn btn-danger" id='Show'>
                                                                            <strong>رفض</strong>
